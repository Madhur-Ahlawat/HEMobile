...
class NominatedPersonalInfoFragmentTest {
    ...
    @Test
    fun `test nominated personal info screen, navigate to next screen`() {
        launchFragmentInHiltContainer<NominatedPersonalInfoFragment>(bundle) {
            navController.setGraph(R.navigation.navigation_profile)
            navController.setCurrentDestination(R.id.nominatedPersonalInfoFragment)
            ...
            assertEquals(
                ...
                R.id.nominatedPostCodeFragment
            )
        }
    }

    @Test
    fun `test nominated personal info screen, navigate to change email screen`() {
        launchFragmentInHiltContainer<NominatedPersonalInfoFragment>(bundle) {
            navController.setGraph(R.navigation.navigation_profile)
            navController.setCurrentDestination(R.id.nominatedPersonalInfoFragment)
            Navigation.setViewNavController(requireView(), navController)
