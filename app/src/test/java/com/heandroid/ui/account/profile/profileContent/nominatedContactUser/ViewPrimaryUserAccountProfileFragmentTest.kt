...
class ViewPrimaryUserAccountProfileFragmentTest {
    ...
    fun `test account profile screen, navigate to next screen for success`() {
        launchFragmentInHiltContainer<ViewPrimaryUserAccountProfileFragment> {
            navController.setGraph(R.navigation.navigation_profile)
            navController.setCurrentDestination(R.id.viewPrimaryAccountUserProfileFragment)
