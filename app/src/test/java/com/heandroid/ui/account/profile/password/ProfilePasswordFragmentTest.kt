...
class ProfilePasswordFragmentTest {
    ...
    fun `test profile password screen, navigate to pin screen`() {
        launchFragmentInHiltContainer<ProfilePasswordFragment>(bundle) {
            navController.setGraph(R.navigation.navigation_profile)
            navController.setCurrentDestination(R.id.passwordFragment)
    ...
    @Test
    fun `test profile password screen, navigate to update password screen`() {
        launchFragmentInHiltContainer<ProfilePasswordFragment>(bundle) {
            navController.setGraph(R.navigation.navigation_profile)
            navController.setCurrentDestination(R.id.passwordFragment)
            Navigation.setViewNavController(requireView(), navController)
