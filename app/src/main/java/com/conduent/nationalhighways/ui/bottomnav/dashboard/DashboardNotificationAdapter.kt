...
import com.conduent.nationalhighways.databinding.DashboardNotificationItemLayoutBinding

class DashboardNotificationAdapter(
    private val context: Context,
    private val list: List<AlertMessage?>?
) : RecyclerView.Adapter<DashboardNotificationAdapter.DashboardNotificationViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): DashboardNotificationAdapter.DashboardNotificationViewHolder =
        DashboardNotificationViewHolder(
            DashboardNotificationItemLayoutBinding.inflate(
    ...
    override fun onBindViewHolder(
        holder: DashboardNotificationAdapter.DashboardNotificationViewHolder,
        position: Int
    ) {
