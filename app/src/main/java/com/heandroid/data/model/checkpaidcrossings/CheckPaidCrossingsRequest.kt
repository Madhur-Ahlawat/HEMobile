package com.heandroid.data.model.checkpaidcrossings
...
@Parcelize
data class CheckPaidCrossingsOptionsModel(var ref: String?,var vrm: String?,var enable: Boolean): Parcelable

@Parcelize
data class EnterVrmOptionsModel(var vrm: String?,var enable: Boolean): Parcelable

@Parcelize
data class UnUsedChargesModel(val trip:Int, val vrm:String, val expiryDate:String="24 June 2023"):Parcelable

@Parcelize
data class UsedChargesModel(val crossingId:String, val vrm:String, val crossingDate:String="1 April 2023", val time:String, val direction:String):Parcelable