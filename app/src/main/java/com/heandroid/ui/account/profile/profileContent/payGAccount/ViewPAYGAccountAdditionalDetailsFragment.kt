...
@AndroidEntryPoint
class ViewPAYGAccountAdditionalDetailsFragment : BaseFragment<FragmentViewPaygAccountUserBinding> (), View.OnClickListener{
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.btnEditDetail -> {
                ...
                findNavController().navigate(R.id.action_viewPaygAdditionalDetails_to_UpdatePersonalInfo,bundle)
            }
