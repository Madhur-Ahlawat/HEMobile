    ...
    override fun onClick(v: View?) {
        ...
        when(v?.id) {
            R.id.btnAction -> {
                ...
                findNavController().navigate(R.id.action_postCodeFragment_to_passwordFragment,bundle)
            ...
            when (response) {
                is Resource.Success -> {
                    ...
                    binding.apply {
                        ...
                        btnFindAddress.backgroundTintList=ContextCompat.getColorStateList(requireActivity(),R.color.green)
